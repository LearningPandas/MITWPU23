          ...
          <ul class="navbar-nav mr-auto container-fluid">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="./contact.html">Any Other Suggestions For Courses</a>
              </div>
            </li>
            ...
            <li class="nav-item col-8">
                ...
                <a class="nav-link btn btn-danger mx-2" href="instructorlogin.php">Instructor Login/Sign Up</a>
                <a class="nav-link btn btn-danger mx-2" href="learnerlogin.php">Learner Login/Sign Up</a>
      ...
      <div class="container " style="margin-top: 120px;">
         <!-- <div class="row">
          ...
          <div class="col text-center">
              ...
              <a href="contact.html" class="btn btn-lg btn-danger">Contact Now</a>
              </div>
            </div>
